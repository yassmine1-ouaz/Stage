        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="index-2.html">
               <!--  <img class="light-mode-item navbar-brand-item" src="{{asset('Front/assets/images/logo.svg')}}" alt="logo">
                <img class="dark-mode-item navbar-brand-item" src="{{asset('Front/assets/images/logo.svg')}}" alt="logo">
            -->
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active dropdown-toggle" href="#" id="homeMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Etat</a>
                        <ul class="dropdown-menu" aria-labelledby="homeMenu">

                            <li> <a class="dropdown-item" href="{{route('user.filtrerEtat','A VENDRE')}}">A VENDRE</a></li>
                            <li> <a class="dropdown-item" href="{{route('user.filtrerEtat','A LOUER')}}">A LOUER</a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active dropdown-toggle" href="#" id="homeMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Filtrer</a>
                        <ul class="dropdown-menu" aria-labelledby="homeMenu">
                            @foreach($villes as $ville)
                            <li> <a class="dropdown-item" href="{{route('user.filtrerVille',$ville->id)}}">{{$ville->name}}</a>
                            </li>
                            @endforeach
                        </ul>
                    </li>
                                    ...
                                    <li>
                                        <div class="list-group-item list-group-item-action rounded badge-unread d-flex border-0 mb-1 p-3">
                                            <div class="avatar text-center d-none d-sm-inline-block">
                                                <img class="avatar-img rounded-circle" src="{{asset('Front/assets/images/avatar/01.jpg')}}" alt="">
                                            </div>
                                            <div class="ms-sm-3">
                                                <div class=" d-flex">
