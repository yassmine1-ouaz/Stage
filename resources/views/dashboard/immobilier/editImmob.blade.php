<!-- Modal editpub START -->
<div class="modal fade" id="modalEditpub{{$immobilier->id}}" tabindex="-1" aria-labelledby="modalLabelCreateAlbum" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal feed header START -->
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabelCreateAlbum">modifier publication</h5>
            ...
            <div class="modal-body">
                <!-- Form START -->
                <form class="row g-4" action="{{ route('updateImmobBack',$immobilier->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @if(Session::get('fail'))
